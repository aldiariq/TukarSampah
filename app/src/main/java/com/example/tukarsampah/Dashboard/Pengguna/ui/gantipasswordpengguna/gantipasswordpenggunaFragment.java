package com.example.tukarsampah.Dashboard.Pengguna.ui.gantipasswordpengguna;
...
public class gantipasswordpenggunaFragment extends Fragment {
    ...
    public void ubahPassword(String Username, String Passlama, String Passbaru, View itemView){
        ...
        Call<Responseoperasi> tampilData = operasipengguna.ubahPassword(Username, Passlama, Passbaru, "PENGGUNA");
